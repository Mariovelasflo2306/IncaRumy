...
//   premiossss
	...
	feedbackSlider.on('changed.owl.carousel', function(property) {
		...
		var prevRating = $(property.target).find(".owl-item").eq(current).prev().find('.customer-rating').attr('data-rating');
		var nextRating = $(property.target).find(".owl-item").eq(current).next().find('.customer-rating').attr('data-rating');
    ...
    .on("click", function (event) {
		...
		var d = new Date(); 
		$(document).ready(function() {
		$(".mes").text( monthNames[d.getMonth()] );
		});
		//dia
		var daye = (new Date).getDate();
		$(document).ready(function() {
		$(".dia").text( daye );
		});
